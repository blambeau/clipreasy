...
#     terminals.all?{|s| s.statement.is_a?(::CliPrEasy::Model::Activity)}.should be_true
#     
#     # close them all in turn and arbitrary order
#     terminals[1].activity_ended.should be_empty
#     ended?(terminals[1]).should be_true
#     pending?(process_exec, main_exec, terminals[0], terminals[2]).should be_true
#     
#     terminals[0].activity_ended.should be_empty
#     ended?(terminals[0], terminals[1]).should be_true
#     pending?(process_exec, main_exec, terminals[2]).should be_true
# 
#     terminals[2].activity_ended.should be_empty
#     ended?(process_exec, main_exec, terminals[0], terminals[1], terminals[2]).should be_true
#   end
# 
# end